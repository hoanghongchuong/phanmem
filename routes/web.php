...
Route::get('phi-dich-vu', 'IndexController@service');
Route::get('download', 'IndexController@download');
Route::get('huong-dan', 'IndexController@huongdan');
...
Route::get('dang-ky','SignupController@signup');
Route::post('dang-ky', 'SignupController@postSignup')->name('postSignup');
